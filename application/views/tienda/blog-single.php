    ...
    <section class="ftco-section ftco-degree-bg ">
      <div class="container justify-content-center">
        <div class="row justify-content-center">
          <div class="col-md-12 col-sm-12 ftco-animate bg-light p-4">
            ...
            <a href="<?php echo base_url(); ?>/blog" class="btn btn-primary" style="padding: 10px 5px !important; width: 35%; ">Atrás</a>
