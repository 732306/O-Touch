      ...
      <div class="container">
        <div class="row no-gutters slider-text align-items-center justify-content-center">
          <div class="col-md-9 ftco-animate text-center">
            ...
            <p class="breadcrumbs"><span class="mr-2"><a href="<?php echo base_url(); ?>">Inicio</a></span> <span>Contacto</span></p>
          </div>
        </div>
      </div>
    </div>
        ...
        <div class="row d-flex mt-5 contact-info">
          ...
          <div class="col-md-3 d-flex">
          	<div class="info bg-white p-4">
	            <p><span>Dirección:</span> Avda. de España, 11 1ºE 24402 Ponferrada (León)</p>
	          </div>
          </div>
          <div class="col-md-3 d-flex">
          	<div class="info bg-white p-4">
	            <p><span>Teléfono:</span> <a href="tel://1234567920"> 987 72 01 55</a></p>
	          </div>
          </div>
          <div class="col-md-3 d-flex">
          	<div class="info bg-white p-4">
	            <p><span>Correo:</span> <a href="mailto:info@yoursite.com">tocados.otouch@gmail.com</a></p>
	          </div>
          </div>
          <div class="col-md-3 d-flex">
          	<div class="info bg-white p-4">
	            <p><span>Web:</span> <a href="#">otouch.com</a></p>
	          </div>
          </div>
        </div>
      </div>
