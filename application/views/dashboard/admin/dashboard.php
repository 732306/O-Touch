  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <a class="sidebar-brand d-flex align-items-center justify-content-center" href="">
        ...
        <div class="sidebar-brand-text mx-3">O'Touch Panel</div>
      </a>
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <!-- Page Heading -->
        <h1 class="h3 mb-4 text-gray-800">Listado</h1>
        ...
        <tbody>
            <?php foreach($usuarios as $usuario): ?>
                <tr>
                    ...
                    <td><?php echo ucwords($usuario->genero); ?></td>
                    <td>
                        <button type="button" class="btn btn-danger btn-sm btn_delete" id="<?php echo $usuario->id; ?>">Eliminar</button>
                        <button type="button" class="btn btn-success btn-sm btn_edit" id="<?php echo $usuario->id; ?>">Editar</button>
                    </td>
                </tr>
            <?php endforeach; ?>
        </tbody>
      ...
      <footer class="sticky-footer bg-white">
        <div class="container my-auto">
          <div class="copyright text-center my-auto">
            <span>Copyright &copy; O'Touch 2019</span>
          </div>
        </div>
      </footer>
      <!-- End of Footer -->
